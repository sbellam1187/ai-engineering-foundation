---
id: ADOPTION-ai-0010-manage-all-agents-in-a-single-agent-control-plane
concern: ai
status: active
...
# ADOPTION-AI-010: Adoption for Manage all agents in a single Agent Control Plane

## Intent
Make the decision in ADR-ai-0010-manage-all-agents-in-a-single-agent-control-plane easy to adopt and hard to bypass.
