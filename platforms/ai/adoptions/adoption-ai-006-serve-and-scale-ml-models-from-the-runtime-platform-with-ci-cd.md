---
id: ADOPTION-ai-0006-serve-and-scale-ml-models-from-the-runtime-platform-with-ci-cd
concern: ai
status: active
...
# ADOPTION-AI-006: Adoption for Serve and Scale ML Models from the Runtime Platform with CI/CD

## Intent
Make the decision in ADR-ai-0006-serve-and-scale-ml-models-from-the-runtime-platform-with-ci-cd easy to adopt and hard to bypass.
