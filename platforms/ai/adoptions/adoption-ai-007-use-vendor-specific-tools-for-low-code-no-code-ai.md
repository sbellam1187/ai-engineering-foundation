---
id: ADOPTION-ai-0007-use-vendor-specific-tools-for-low-code-no-code-ai
concern: ai
status: active
...
# ADOPTION-AI-007: Adoption for Use Vendor-Specific Tools for Low-Code/No-Code AI

## Intent
Make the decision in ADR-ai-0007-use-vendor-specific-tools-for-low-code-no-code-ai easy to adopt and hard to bypass.
