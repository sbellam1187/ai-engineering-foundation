---
id: ADOPTION-ai-0015-logical-idempotency-and-side-effect-classification
concern: ai
status: active
...
# ADOPTION-AI-015: Adoption for Logical Idempotency and Side-Effect Classification

## Intent
Make the decision in ADR-ai-0015-logical-idempotency-and-side-effect-classification easy to adopt and hard to bypass.
