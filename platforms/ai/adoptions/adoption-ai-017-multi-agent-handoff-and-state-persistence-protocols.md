---
id: ADOPTION-ai-0017-multi-agent-handoff-and-state-persistence-protocols
concern: ai
status: active
...
# ADOPTION-AI-017: Adoption for Multi-Agent Handoff and State Persistence Protocols

## Intent
Make the decision in ADR-ai-0017-multi-agent-handoff-and-state-persistence-protocols easy to adopt and hard to bypass.
